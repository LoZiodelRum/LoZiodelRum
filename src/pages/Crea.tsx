...
export default function Crea() {
  ...
  return (
    <div className="crea-page page fade-in" style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
      <Navbar />
      ...
      <form onSubmit={handleSubmit} style={{ background: "#171717", border: "1px solid #3f3f46", borderRadius: 16, padding: 18, marginBottom: 24 }}>
