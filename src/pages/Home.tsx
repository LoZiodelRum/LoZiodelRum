      {/* Pulsanti registrazione in fondo, stile allegato */}
      <div style={{
        width: "100vw",
        display: "flex",
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: 38, fontWeight: 800, marginBottom: 8, color: "#fff", textAlign: "center" }}>Registrati</h1>
          <div style={{ color: "#aaa", fontSize: 20, marginBottom: 28, textAlign: "center" }}>Scegli il tuo ruolo</div>
