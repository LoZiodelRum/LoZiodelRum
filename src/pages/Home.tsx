...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Modulo Crea il tuo Cocktail in fondo */}
      <section className="content-section" style={{ padding: "40px 60px", maxWidth: 900, margin: "0 auto 60px auto" }}>
        <h2 style={{ color: "#f5a623", marginBottom: 18, textAlign: "center" }}>Crea il tuo Cocktail</h2>
        {!isAuthenticated && (
          <div style={{ color: "#f87171", marginBottom: 18, fontWeight: 500, textAlign: "center" }}>
        ...
        {error && <div style={{ color: "#f87171", marginBottom: 18, textAlign: "center" }}>{error}</div>}
        {showResults && suggestions.length > 0 && (
          <div style={{ marginTop: 24 }}>
            <h3 style={{ color: "#f5a623", marginBottom: 12, textAlign: "center" }}>Suggerimenti</h3>
            <div style={{ display: "grid", gap: 24 }}>
              {suggestions.map((cocktail, idx) => (
                <div key={cocktail.name + idx} style={{ background: "#232323", borderRadius: 14, padding: 18 }}>
                  <h4 style={{ color: "#f5a623", margin: 0 }}>{cocktail.name}</h4>
